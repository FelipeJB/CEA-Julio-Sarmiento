    ...
    public function updatePassword()
    {
        ...
        if (Hash::check($contraVieja, Auth::user()->password)) {
          ...
          if($contraNueva1 != $contraNueva2){
            return Redirect::to('/#Administrar')->with("error", "Contraseñas nuevas no coinciden");
          }

          //validar 6 caracteres mínimo
          else if(strlen($contraNueva1)<6){
            return Redirect::to('/#Administrar')->with("error", "Contraseña nueva debe tener más de 6 caracteres");
          }
          ...
          $user->save();
          return Redirect::to('/#Administrar')->with("nueva", "Contraseña actualizada");
          }
          ...
          return Redirect::to('/#Administrar')->with("error", "Contraseña actual incorrecta");
        }
